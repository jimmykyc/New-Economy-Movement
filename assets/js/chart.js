...
! function (t, e) {
        ...
        if (!(isNaN(p) || p <= 0)) {
            switch (t.beginPath(), f) {
                default:
                    ...
                    break;
                case "triangle":
                    c = n ? n / 2 : p, t.moveTo(i + Math.sin(m) * c, s - Math.cos(m) * p), m += R, t.lineTo(i + Math.sin(m) * c, s - Math.cos(m) * p), m += R, t.lineTo(i + Math.sin(m) * c, s - Math.cos(m) * p), t.closePath();
                    break;
                case "rectRounded":
                    h = .516 * p, l = p - h, a = Math.cos(m + E) * l, d = Math.cos(m + E) * (n ? n / 2 - h : l), r = Math.sin(m + E) * l, u = Math.sin(m + E) * (n ? n / 2 - h : l), t.arc(i - d, s - r, h, m - D, m - L), t.arc(i + u, s - a, h, m - L, m), t.arc(i + d, s + r, h, m, m + L), t.arc(i - u, s + a, h, m + L, m + D), t.closePath();
                    break;
                case "rect":
                    if (!g) {
                ...
                case "cross":
                    ...
                    break;
                case "star":
                    d = Math.cos(m) * (n ? n / 2 : p), a = Math.cos(m) * p, r = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p), t.moveTo(i - d, s - r), t.lineTo(i + d, s + r), t.moveTo(i + u, s - a), t.lineTo(i - u, s + a), m += E, d = Math.cos(m) * (n ? n / 2 : p), a = Math.cos(m) * p, r = Math.sin(m) * p, u = Math.sin(m) * (n ? n / 2 : p), t.moveTo(i - d, s - r), t.lineTo(i + d, s + r), t.moveTo(i + u, s - a), t.lineTo(i - u, s + a);
                    break;
                case "line":
    ...
    return Sn.register(Vn, Ra, oo, sa), Sn.helpers = {
        ...Bi
